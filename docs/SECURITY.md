...
- Output (LLM05): safe markdown path; strict CSP allowlist + Upstash multi-instance limits tracked (current CSP has `unsafe-inline`/`connect *` — documented, not silent).
